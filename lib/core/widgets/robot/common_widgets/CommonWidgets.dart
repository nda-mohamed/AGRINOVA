        ...
        children: [
          Row(
            ...
            children: [
              Text(
                label,
                style: const TextStyle(color: AppColor.gray, fontSize: 14),
              ),
          ...
          Row(
            mainAxisAlignment: MainAxisAlignment.spaceBetween,
            children: const [
              Text('Mon', style: TextStyle(fontSize: 10, color: AppColor.gray)),
              Text('Tue', style: TextStyle(fontSize: 10, color: AppColor.gray)),
              Text('Wed', style: TextStyle(fontSize: 10, color: AppColor.gray)),
              Text('Thu', style: TextStyle(fontSize: 10, color: AppColor.gray)),
              Text('Fri', style: TextStyle(fontSize: 10, color: AppColor.gray)),
              Text('Sat', style: TextStyle(fontSize: 10, color: AppColor.gray)),
              Text('Sun', style: TextStyle(fontSize: 10, color: AppColor.gray)),
            ],
          ),
        ],
      ),
